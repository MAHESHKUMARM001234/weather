  ...
  return (
    <div>
      <div className='contactheader'>
        <p style={{color:'rgba(64,45,134,255)', fontSize: 70, padding: '50px 200px', backgroundColor: 'rgba(247,248,250,255)'}}><b>Contact Us</b></p>
      </div>
      ...
      <div className='contactmap'>
        <center>
          <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3935.304395435121!2d77.50941598502861!3d9.482230957504827!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3b06e889902bcc45%3A0x789aff6d63c7062a!2sRamco%20Institute%20of%20Technology!5e0!3m2!1sen!2sin!4v1720852606930!5m2!1sen!2sin" width="1200" height="700" style={{border:'1px solid black',padding:'20px 20px 20px 20px', borderRadius:10}} allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade" id='map' title='map'/>
        </center>
      </div>
    </div>
  );
