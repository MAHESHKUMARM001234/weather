  ...
  return (
    <div>
        ...
        <div className="subscripenews">
            <p style={{ color: 'white', fontSize: '50px', width: '600px', textAlign: 'justify' }}>
            ...
            <div className="emailcart">
                ...
                <input type="button" value="Submit" style={{ color: 'white', padding: '0px 20px 10px 20px', backgroundColor: 'rgb(80, 77, 255)', borderRadius: '30px', border: 'none', fontSize: '20px' }} />
                </form>
            </div>
        </div>
