    ...
    <div>
        <div className="partone">
            <div className="bannersection">
                ...
                <div>
                    <div className="cart">
                        <p style={{color: 'white',padding: '10px 20px 10px 20px',backgroundColor: 'rgb(28, 28, 255)',borderRadius: 10,display: 'inline-block',fontsize: 15}}>Today</p>
                        <div className="carddetails">
                            <img src={icon} alt="" width="150px" height="100px" />
            ...
            <div className='allmaps'>
                <div className='temparature'>
                    <div  className='mapcontent'>
                        <p style={{color: 'rgp()',fontSize:40,paddingBottom:20,paddingTop:20}}><b>Temperature</b></p>
                        <p style={{maxWidth:500,fontSize:20,paddingBottom:20, textAlign:'justify'}}>Temperature is a measure of the average kinetic energy of particles in a substance, indicating how hot or cold it is.</p>
                        <button style={{padding:'20px 25px', border: '2px solid black', borderRadius:30,fontSize:25,backgroundColor:'white'}} onClick={() => navigate(`/temp?location1=${encodeURIComponent(location1)}`)}><b>Preview Map</b></button>
                    </div>
                    <img src={temp} width={400} height={300}/>
                </div>
                <div className='temparature'>
                    <div  className='mapcontent'>
                        <p style={{color: 'rgp()',fontSize:40,paddingBottom:20,paddingTop:20}}><b>Clouds</b></p>
                        <p style={{maxWidth:500,fontSize:20,paddingBottom:20, textAlign:'justify'}}>A cloud is a visible mass of condensed water vapor or ice crystals suspended in the atmosphere.</p>
                        <button style={{padding:'20px 25px', border: '2px solid black', borderRadius:30,fontSize:25,backgroundColor:'white'}} onClick={() => navigate(`/cloud?location1=${encodeURIComponent(location1)}`)}><b>Preview Map</b></button>
                    </div>
                    <img src={cloud} width={400} height={300}/>
                </div>
                <div className='temparature'>
                    <div  className='mapcontent'>
                        <p style={{color: 'rgp()',fontSize:40,paddingBottom:20,paddingTop:20}}><b>Wind</b></p>
                        <p style={{maxWidth:500,fontSize:20,paddingBottom:20, textAlign:'justify'}}>Wind is the movement of air from high-pressure areas to low-pressure areas in the Earth's atmosphere.</p>
                        <button style={{padding:'20px 25px', border: '2px solid black', borderRadius:30,fontSize:25,backgroundColor:'white'}} onClick={() => navigate(`/wind?location1=${encodeURIComponent(location1)}`)}><b>Preview Map</b></button>
                    </div>
                    <img src={windnew} width={400} height={300}/>
                </div>
                <div className='temparature'>
                    <div  className='mapcontent'>
                        <p style={{color: 'rgp()',fontSize:40,paddingBottom:20,paddingTop:20}}><b>Sea Level Pressure</b></p>
                        <p style={{maxWidth:500,fontSize:20,paddingBottom:20, textAlign:'justify'}}>Sea Level Pressure (SLP) is the atmospheric pressure at sea level, which is used as a standard reference to compare pressures from different locations and altitudes.</p>
                        <button style={{padding:'20px 25px', border: '2px solid black', borderRadius:30,fontSize:25,backgroundColor:'white'}} onClick={() => navigate(`/pressure?location1=${encodeURIComponent(location1)}`)}><b>Preview Map</b></button>
                    </div>
                    <img src={pressure1} width={400} height={300}/>
                </div>
            </div>
        </div>
    </div>
