            ...
            (article.urlToImage && article.title && article.description && article.url) && (
              <div className='paddingcart' key={index}>
                <div className='weathercart'>
                  ...
                  <p style={{ fontSize: 30, width: 350, paddingBottom: 10, maxHeight: 200, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                    <b>{article.title}</b>
                  </p>
                  <p style={{ fontSize: 15, width: 350, paddingBottom: 20 , maxHeight: 30, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap'}}>
                    {article.description}
                  </p>
